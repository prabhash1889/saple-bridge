...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            missions::mission_settle_report,
            missions::mission_request_gate,
            missions::mission_resolve_gate,
            missions::mission_publish_artifact,
            missions::mission_ask,
            missions::mission_reply,
            missions::mission_send_message,
            missions::mission_inbox_fetch,
            missions::mission_inbox_ack,
            missions::mission_worktree_create,
            missions::mission_worktree_diff,
            missions::mission_worktree_merge,
            missions::mission_worktree_remove,
            missions::mission_worktree_list,
...
mod tests {
    ...
    const EXPECTED_COMMANDS: &[&str] = &[
        ...
        "mission_tick",
        "mission_recover",
        "mission_settle_report",
        "mission_request_gate",
        "mission_resolve_gate",
